...
col_types = c("date", "text", "text", "text", "numeric", "numeric", "numeric")


read_and_process_data_drysalesmotor <- function(filepath) {
  Data <- read_excel(filepath, sheet = "MOTOR", col_types = c("date", "text", "text", "text", "numeric", "numeric", "numeric"))
...
read_and_process_data_drysalesmedical <- function(filepath) {
  Data <- read_excel(filepath, sheet = "MEDICAL", col_types = c("date", "text", "text", "text", "numeric", "numeric", "numeric"))
